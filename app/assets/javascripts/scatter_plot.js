...
function draw(dataset) {
  ...
  // function parseDatetime returns a datetime object when given a string
  ...
  var x_scale = d3.time.scale()
    .range([0 + left_pad, width / 1.4 ]) // scale for max and min svg values
    .domain(x_extent); // scale for max and min data value
