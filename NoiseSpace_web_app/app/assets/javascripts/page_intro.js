...
function welcomeInfo() {
  ...
  $('.welcome-info').append('<p welcome-message>'+ welcomeMessage +'</p>').fadeOut(0).fadeIn(4000).delay(1000).fadeOut(4000, function () {
    healthInfo();
  });
}
...
function noiseExperience() {
  ...
  $('.noise-experience').append('<p noise-experience-message>'+ noiseExperienceMessage +'</p>').fadeOut(0).fadeIn(4000).delay(1000).fadeOut(4000, function () {
    noiseDataMessage();
  });
}
...
function noiseDataMessage() {
  ...
  $('.noise-data-info').append('<p noise-data-message>'+ noiseDataMessage +'</p>').fadeOut(0).fadeIn(4000).delay(1000).fadeOut(4000, function () {
